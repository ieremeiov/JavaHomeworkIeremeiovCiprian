...
public class Main {
    ...
    // can take objects out of the queue, when the delay expires
    // the queue is sorted, so that the head has a delay that has expired for the longest time
    public static void main(String[] args) {
        ...
        try {
            ...
            queue.put(new DelayedWorker(6000, "This is the second message"));
