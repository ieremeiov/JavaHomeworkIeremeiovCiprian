...
public class Calculator {
    ...
    /**
     * Turns on the calculator, then asks: first number, then operation, then
     * the second number and finally the equals sign. Press "Enter" after every
     * input. When asked if you want to make another computation press 'y' or
     * 'Y' for affirmative; press anything else to close the ComputerOOP.
     */
    public void turnOn() {
